...
const InputArea: React.FC<InputAreaProps> = ({ onSendMessage, isLoading }) => {
  ...
  return (
    <div className="bg-transparent">
      ...
      <p className="text-center text-[9px] md:text-[10px] text-slate-300 font-black uppercase tracking-[0.4em] pointer-events-none">Obsidian Protocol v29.0 Total Restoration</p>
    </div>
  );
};
