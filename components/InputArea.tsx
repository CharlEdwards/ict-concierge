  ...
  return (
    <div className="bg-transparent">
      <form onSubmit={handleSubmit} className="relative flex items-center gap-4">
        ...
        >
          {isListening ? (
            <div className="flex gap-1.5 items-center">import React, { useState, useRef, useEffect } from 'react';
import { INDUSTRY_CONFIG } from '../constants';
...
const InputArea: React.FC<InputAreaProps> = ({ onSendMessage, isLoading }) => {
  ...
  return (
    <div className="bg-transparent">
      ...
      <p className="text-center text-[9px] md:text-[10px] text-slate-300 font-black uppercase tracking-[0.4em] pointer-events-none">Obsidian Protocol v46.0 Centralized Concierge</p>
    </div>
  );
};
...
export default InputArea;
      ...
      <div className="h-6"></div>
      <p className="text-center text-[9px] md:text-[10px] text-slate-300 font-black uppercase tracking-[0.4em] pointer-events-none">Obsidian Protocol v45.0 Strategic Conversationalist</p>
    </div>
  );
};
